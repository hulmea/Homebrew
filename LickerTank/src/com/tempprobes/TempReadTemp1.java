...
public static double temp() throws IOException{
		String allfile = TempReadTemp1.readFile("/sys/bus/w1/devices/28-0000055083da/w1_slave", StandardCharsets.UTF_8);
